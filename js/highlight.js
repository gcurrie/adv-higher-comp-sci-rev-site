...
(function () {
  ...
  const KEYWORDS = new Set([
    ...
    /* Advanced Higher object-oriented additions */
    'CLASS', 'IS', 'METHODS', 'CONSTRUCTOR', 'THIS', 'INHERITS', 'OVERRIDE',
    'WITH', 'self'
  ]);
  ...
  const SQL_KEYWORDS = new Set([
    ...
    /* Advanced Higher DDL/DML additions */
    'DATABASE', 'DROP', 'PRIMARY', 'FOREIGN', 'KEY', 'REFERENCES', 'CHECK',
    'AUTO_INCREMENT', 'ANY', 'ALL'
  ]);
