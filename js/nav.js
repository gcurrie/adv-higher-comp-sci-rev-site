/* Shared navigation injection — Advanced Higher Computing Science */
(function () {
  const ROOT = (function () {
  ...
  const LINKS = [
    ...
    { href: 'sdd/', label: 'SDD' },
    { href: 'ddd/', label: 'DDD' },
    { href: 'project/', label: 'Project Tips' },
  ...
  function currentActive(href) {
    ...
    return path.includes('/' + href); // href ends with '/', so 'sdd/' only matches the /sdd/ folder
  }
  ...
  <div class="header-inner">
    <a href="${ROOT}index.html" class="site-logo">
      ...
      <div class="logo-text">
        ...
        <span class="logo-sub">Advanced Higher Revision</span>
      </div>
    </a>
  ...
  <div class="footer-inner">
    <div class="footer-brand">
      ...
      <div>
        ...
        <p>Advanced Higher Computing Revision</p>
      </div>
    </div>
    <div class="footer-links">
      <a href="${ROOT}index.html">Home</a>
      <a href="${ROOT}integration/index.html">Integration — Analysis, Testing &amp; Evaluation</a>
      <a href="${ROOT}sdd/index.html">Software Design &amp; Development</a>
      <a href="${ROOT}ddd/index.html">Database Design &amp; Development</a>
      <a href="${ROOT}project/index.html">Project Tips</a>
